const hubConnection=(new signalR.HubConnectionBuilder).withUrl(HubUrl).configureLogging(signalR.LogLevel.Information).build();$(document).ready(function(){hubConnection.on("Send",function(n,t,i,r,u){DialogID===r?($("#dialog").append(`<div class="mt-2">
                    <div class="d-flex">
                ...
                </div>`),$("#message").val(""),$("#dialog").scrollTop($("#dialog")[0].scrollHeight)):(toastr.info(`Вам пришло новое сообщение от ${t}`),toastr.info(`<a href="~/Dialog/WithId/${r}">
	                        <p>Новое сообщение!</p>
	                        <div class="d-flex">
